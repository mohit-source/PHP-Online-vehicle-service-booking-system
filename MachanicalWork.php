...
include('DBconfig.php');
 session_start();
	...
	$emailE=$_SESSION['email'];
				$query    = "SELECT * FROM employee where Email='$emailE'";
...
?>
			...
			<?php
				...
				$query    = "SELECT * FROM `order` where Machanical = '$Ename' and view = '1'  ";
				$result = mysqli_query($conn,$query);
				if(mysqli_num_rows($result)>0)
				{
					...
					echo  ' <tbody>
							<tr>
								...
								<td> <a href="paymentDetails.php?Id='.$row['Id']. '"> <div class="btn btn-success">View</div></a></td>
